...
/* ---------------------------------------------------------------------- *
 * VT08 — every StatementIterator vtable field is pointer-identical to its
 * flat counterpart
 * ---------------------------------------------------------------------- */
static void test_vt08_statement_iterator_matches_flat(void) {
   TestBit.is_true(StatementIterator.next == anvil_statement_iterator_next,
