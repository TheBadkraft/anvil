...
│   ├── sigma/          ← embedded: types, allocator, strings interfaces
│   └── sigma/        ← embedded: bump arena + Allocator vtable
├── src/
...
Measured on Linux x86-64, `-O0 -g` (debug build), sigma 0.2.5 resource-scope bump allocator.
...
| Allocator                       | JVM GC    | sigma Arena   | **sigma Resource (mmap bump)** | —      |
...
> **sigma team note:** FT-12 (`Allocator.Resource` scope) eliminated all BTree/skiplist overhead from
