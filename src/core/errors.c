...
static const char *error_messages[] = {
   ...
   [ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_ATTRIBUTE] = "'$' VarRef sigil is not allowed in an attribute value",
   [ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_FRAGMENT] = "'$' VarRef sigil is not allowed in a Value Fragment, at any nesting depth",
   [ANVL_ERR_PARSER_INVALID_SHEBANG_DIALECT] = "Shebang dialect not recognized (must be #!aml, #!amp, or #!asl)",
   ...
   [ANVL_ERR_PARSER_INVALID_BARE_LITERAL] = "'@'/'`' are not valid inside a bare literal",
   ...
   [ANVL_ERR_INCLUDE_NOT_FIRST] = "include declarations must precede statements",
   [ANVL_ERR_INCLUDE_AMP_FORBIDDEN] = "include is not allowed in AMP dialect",
   [ANVL_ERR_INCLUDE_DUPLICATE_ALIAS] = "Duplicate include alias",
   [ANVL_ERR_INCLUDE_FILE_NOT_FOUND] = "Included file not found",
   [ANVL_ERR_INCLUDE_CYCLIC] = "Cyclic include detected",

   [ANVL_ERR_IMPORT_MODULE_NOT_FOUND] = "import: module not found",
   [ANVL_ERR_IMPORT_IN_AMP] = "import is not allowed in AMP dialect",
   [ANVL_ERR_IMPORT_AFTER_STATEMENTS] = "import declarations must precede statements",
...
static const char *error_names[] = {
   ...
   [ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_ATTRIBUTE] = "ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_ATTRIBUTE",
   [ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_FRAGMENT] = "ANVL_ERR_PARSER_VARREF_NOT_ALLOWED_IN_FRAGMENT",
   [ANVL_ERR_PARSER_INVALID_SHEBANG_DIALECT] = "ANVL_ERR_PARSER_INVALID_SHEBANG_DIALECT",
   ...
   [ANVL_ERR_PARSER_INVALID_BARE_LITERAL] = "ANVL_ERR_PARSER_INVALID_BARE_LITERAL",
   ...
   [ANVL_ERR_INCLUDE_NOT_FIRST] = "ANVL_ERR_INCLUDE_NOT_FIRST",
   [ANVL_ERR_INCLUDE_AMP_FORBIDDEN] = "ANVL_ERR_INCLUDE_AMP_FORBIDDEN",
   [ANVL_ERR_INCLUDE_DUPLICATE_ALIAS] = "ANVL_ERR_INCLUDE_DUPLICATE_ALIAS",
   [ANVL_ERR_INCLUDE_FILE_NOT_FOUND] = "ANVL_ERR_INCLUDE_FILE_NOT_FOUND",
   [ANVL_ERR_INCLUDE_CYCLIC] = "ANVL_ERR_INCLUDE_CYCLIC",

   [ANVL_ERR_IMPORT_MODULE_NOT_FOUND] = "ANVL_ERR_IMPORT_MODULE_NOT_FOUND",
   [ANVL_ERR_IMPORT_IN_AMP] = "ANVL_ERR_IMPORT_IN_AMP",
   [ANVL_ERR_IMPORT_AFTER_STATEMENTS] = "ANVL_ERR_IMPORT_AFTER_STATEMENTS",
