...
/* Global Error State                                                 */
/* ----------------------------------------------------------------- */
static anvl_error_state global_error_state = {.code = ANVL_ERR_NONE,
                                              .message = NULL,
                                              .line = 0,
                                              .column = 0,
                                              .file = NULL};
...
static const char *error_messages[] = {
    ...
    [ANVL_ERR_FILE_READ] =
        "Error finding or reading source file",
    ...
    [ANVL_ERR_PARSER_SHEBANG_AFTER_STATEMENTS] =
        "Shebang must be first non-whitespace line",
    ...
    [ANVL_ERR_PARSER_EMPTY_ATTRIBUTE_BLOCK] =
        "Attribute blocks cannot be empty",

    [ANVL_ERR_PARSER_EXPECTED_OBJECT_FIELD] = "Expected object key",
    [ANVL_ERR_PARSER_EXPECTED_OBJECT_VALUE] =
        "Expected object content after ':='",
    ...
    [ANVL_ERR_PARSER_EXPECTED_TUPLE_CLOSE] =
        "Expected ')' to close tuple content",
    ...
    [ANVL_ERR_PARSER_TUPLE_TOO_FEW_ELEMENTS] =
        "Tuples must have at least 2 elements",
    [ANVL_ERR_PARSER_MISSING_COMMA_IN_ATTRIBUTES] =
        "Missing ',' in attribute block",
    [ANVL_ERR_PARSER_UNEXPECTED_MODULE_ATTRIBUTES] =
        "Module attributes must be prior to statements",
    [ANVL_ERR_PARSER_UNEXPECTED_TOKEN] = "Unexpected token",

    [ANVL_ERR_PARSER_DUPLICATE_FIELD_IN_OBJECT] =
        "Duplicate identifier in document or object",
    ...
    [ANVL_ERR_PARSER_ATTRIBUTE_IS_KEYWORD] =
        "Attribute name cannot be a keyword",
    ...
    [ANVL_ERR_PARSER_INVALID_ATTRIBUTE_BLOCK] =
        "Invalid attribute block; must be `@[...]`",
    [ANVL_ERR_PARSER_INVALID_ATTRIBUTE] = "The attribute identifier is invalid",
    [ANVL_ERR_PARSER_DUPLICATE_ATTRIBUTE_KEY] =
    ...
    [ANVL_ERR_USING_AFTER_STATEMENTS] =
        "using declarations must precede statements",
    ...
    [ANVL_ERR_SCHEMA_BASE_UNKNOWN] =
        ...
        "known schema type",
    [ANVL_ERR_SCHEMA_VALIDATION_REQUIRED] =
        "Required field is missing in the data document",
...
static const char *error_names[] = {
    ...
    [ANVL_ERR_PARSER_EXPECTED_IDENTIFIER] =
        "ANVL_ERR_PARSER_EXPECTED_IDENTIFIER",
    ...
    [ANVL_ERR_PARSER_EXPECTED_OBJECT_FIELD] =
        "ANVL_ERR_PARSER_EXPECTED_OBJECT_FIELD",
    [ANVL_ERR_PARSER_EXPECTED_OBJECT_VALUE] =
        "ANVL_ERR_PARSER_EXPECTED_OBJECT_VALUE",
    [ANVL_ERR_PARSER_EXPECTED_OBJECT_CLOSE] =
        "ANVL_ERR_PARSER_EXPECTED_OBJECT_CLOSE",
    [ANVL_ERR_PARSER_TRAILING_COMMA_IN_OBJECT] =
        "ANVL_ERR_PARSER_TRAILING_COMMA_IN_OBJECT",
    [ANVL_ERR_PARSER_MISSING_COMMA_IN_ARRAY] =
        "ANVL_ERR_PARSER_MISSING_COMMA_IN_ARRAY",
    [ANVL_ERR_PARSER_EXPECTED_ARRAY_CLOSE] =
        "ANVL_ERR_PARSER_EXPECTED_ARRAY_CLOSE",
    [ANVL_ERR_PARSER_EXPECTED_TUPLE_CLOSE] =
        "ANVL_ERR_PARSER_EXPECTED_TUPLE_CLOSE",
    [ANVL_ERR_PARSER_EMPTY_OBJECT_NOT_ALLOWED] =
    ...
    [ANVL_ERR_PARSER_DUPLICATE_FIELD_IN_OBJECT] =
        "ANVL_ERR_PARSER_DUPLICATE_FIELD_IN_OBJECT",
    [ANVL_ERR_PARSER_INVALID_KEY_IN_OBJECT] =
        "ANVL_ERR_PARSER_INVALID_KEY_IN_OBJECT",
    [ANVL_ERR_PARSER_IDENTIFIER_IS_KEYWORD] =
        "ANVL_ERR_PARSER_IDENTIFIER_IS_KEYWORD",
    [ANVL_ERR_PARSER_ATTRIBUTE_IS_KEYWORD] =
        "ANVL_ERR_PARSER_ATTRIBUTE_IS_KEYWORD",
    [ANVL_ERR_PARSER_TUPLE_TOO_SHORT] = "ANVL_ERR_PARSER_TUPLE_TOO_SHORT",
    [ANVL_ERR_PARSER_EXPECTED_COMMA_IN_TUPLE] =
        "ANVL_ERR_PARSER_EXPECTED_COMMA_IN_TUPLE",
    [ANVL_ERR_PARSER_EMPTY_TUPLE_ELEMENT] =
        "ANVL_ERR_PARSER_EMPTY_TUPLE_ELEMENT",
    [ANVL_ERR_PARSER_ROCKET_OP_NOT_VALID] =
        "ANVL_ERR_PARSER_ROCKET_OP_NOT_VALID",
    [ANVL_ERR_PARSER_ARRAY_CANNOT_BE_EMPTY] =
        "ANVL_ERR_PARSER_ARRAY_CANNOT_BE_EMPTY",
    [ANVL_ERR_PARSER_ASSIGNMENT_NOT_ALLOWED_HERE] =
        "ANVL_ERR_PARSER_ASSIGNMENT_NOT_ALLOWED_HERE",
    [ANVL_ERR_PARSER_INVALID_ATTRIBUTE_BLOCK] =
        "ANVL_ERR_PARSER_INVALID_ATTRIBUTE_BLOCK",
    ...
    [ANVL_ERR_PARSER_UNTERMINATED_STRING] =
        "ANVL_ERR_PARSER_UNTERMINATED_STRING",
    ...
    [ANVL_ERR_PARSER_UNTERMINATED_FREEFORM] =
        "ANVL_ERR_PARSER_UNTERMINATED_FREEFORM",
    [ANVL_ERR_PARSER_INVALID_HEX_LITERAL] =
        "ANVL_ERR_PARSER_INVALID_HEX_LITERAL",
 ...
 * ----------------------------------------------------------------- */
void anvl_error_set_global(anvl_error_code code, usize line, usize column,
                           const char *file) {
...
void anvl_error_set(list target, anvl_error_code code, usize line, usize column,
                    const char *file) {
  if (!target) {
    // If target is NULL, set the global error state
    anvl_error_set_global(code, line, column, file);
    return;
  }

  if (!target) {
    // if the target does not have an error list, then set global error state
    anvl_error_set_global(code, line, column, file);
    return;
  }
  list errors = target;
  ...
  anvl_error_state *new_error =
      (anvl_error_state *)malloc(sizeof(anvl_error_state));
  if (!new_error) {
    // If memory allocation fails, set global error state
    anvl_error_set_global(ANVL_ERR_MEMORY_ALLOCATION_FAILED, line, column,
                          file);
    return;
  }
